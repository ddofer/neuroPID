...
#Some new features not put in featuregen classic
import re
import numpy as np
import sys
...
#Used to filter out ,U,B,Z,X non standrd AAs from a given sequence/string. Returns true if illegals present
#@autojit
